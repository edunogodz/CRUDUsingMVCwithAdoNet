    ...
    public class PessoaRepository : AbstractRepository<Pessoa, int>
    {
        ...
        public override void Save(Pessoa entity)
        {
            using (var conn = new SqlConnection(StringConnection))
            {
                ...
                cmd.Parameters.AddWithValue("@Email", entity.Email == null ? string.Empty: entity.Email);
                cmd.Parameters.AddWithValue("@Cidade", entity.Cidade == null ? string.Empty : entity.Cidade);
                cmd.Parameters.AddWithValue("@Endereco", entity.Endereco == null ? string.Empty : entity.Endereco);
                try
                {
                    conn.Open();
                    cmd.ExecuteNonQuery();
